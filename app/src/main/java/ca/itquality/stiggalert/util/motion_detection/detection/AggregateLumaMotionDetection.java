package ca.itquality.stiggalert.util.motion_detection.detection;
 ...
 */
public class AggregateLumaMotionDetection implements ca.itquality.stiggalert.util.motion_detection.detection.IMotionDetection {
    ...
    protected static boolean isDifferent(int[] first, int width, int height) {
        ...
        ca.itquality.stiggalert.util.motion_detection.detection.Comparer comparer = new ca.itquality.stiggalert.util.motion_detection.detection.Comparer(state, mPreviousState, mXBoxes, mYBoxes, mLeniency, mDebugMode);
